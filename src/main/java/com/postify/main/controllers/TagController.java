...
public class TagController {
    ...
    @PutMapping("/{name}")
    public ResponseEntity<TagResponseDto> updateTagName(@PathVariable String name, @RequestBody TagRequestDto tagRequestDto){
    return new ResponseEntity<TagResponseDto>(tagService.convertToTagResponseDto(tagService.updateTag(name,tagRequestDto)), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<TagResponseDto>> getAllTags(){
        return new ResponseEntity<List<TagResponseDto>> (tagService
                .getAll().stream()
