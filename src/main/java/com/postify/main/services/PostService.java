...
public class PostService {
    ...
    public Post create(Post post, int userId) {
        ...
        emailService.sendEmail(user.getEmail(), "Post Creation",
                "Your Post with Title:"+post.getTitle()+" has been created sucessfully on:"+post.getCreatedDate());
        return savePost;
    }
    ...
    public void delete(int id, int userId) {
        ...
        // Save user to update their posts collection
    ...
    public PostResponseDto convertToPostResponseDto(Post post) {
        ...
        postResponseDto.setCreateDate(post.getCreatedDate());
    ...
    public Post convertToPost(PostRequestDto postRequestDto) {
        ...
        post.setTags(postRequestDto.getTags().stream().map(Tag::new).collect(Collectors.toSet()));
        return post;
    }
